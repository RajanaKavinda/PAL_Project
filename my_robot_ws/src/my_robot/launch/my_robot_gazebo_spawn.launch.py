...
def generate_launch_description():
    ...
    robot_namespace = LaunchConfiguration("robot_namespace", default='my_robot')
    
    # Path to the Xacro file
    xacro_path = join(my_robot_path, 'urdf', 'my_robot.xacro')
    ...
    spawn_entity = Node(
        ...
        arguments=[
            ...
            '-entity', PythonExpression(['"', robot_namespace, '_robot"']), #default enitity name _my_robot
            '-z', "0.28",
            '-x', position_x,
            '-y', position_y,
            '-Y', orientation_yaw
