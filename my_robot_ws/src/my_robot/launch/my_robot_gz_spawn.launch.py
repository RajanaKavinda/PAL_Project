...
def generate_launch_description():
    ...
    robot_state_publisher = Node(
        ...
        parameters=[
                    ...
                    ['xacro ', join(my_robot_path, 'urdf/my_robot.xacro'),
    ...
    gz_ros2_bridge = Node(
        ...
        arguments=[
            ...
            "/world/default/model/my_robot/joint_state@sensor_msgs/msg/JointState[gz.msgs.Model"
        ],
        remappings=[
            ...
            ('/kinect_camera/points', 'my_robot/kinect_camera/points'),
        ]
    )
    ...
    transform_publisher = Node(
        ...
        arguments = ["--x", "0.0",
                    ...
                    "--child-frame-id", "my_robot/base_footprint/kinect_camera"]
    )
